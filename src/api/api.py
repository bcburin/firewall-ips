...
from src.api.endpoints import critical_rules, firewall_rules, user, development, ensemble
...
api.include_router(development.router)
api.include_router(ensemble.router)
